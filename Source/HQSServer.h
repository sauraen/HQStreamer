...
#ifndef HQSSERVER_H_INCLUDED
#define HQSSERVER_H_INCLUDED

#include "JuceHeader.h"
#include "PluginProcessor.h"

class HQSServer : public InterprocessConnectionServer {
public:
    HQSServer(HqstreamerAudioProcessor& p);
    ~HQSServer();
